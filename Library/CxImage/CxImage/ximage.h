...
ForceInline float log2f(const float x)
{
    INLINE_ASM
    {
        fld1;
...
ForceInline double log2(const double x)
{
    INLINE_ASM
    {
        fld1;
...
ForceInline USHORT my_ntohs(USHORT netshort)
{
...
/** \addtogroup Protected */ //@{
	...
	static int CDECL CompareColors(const void *elem1, const void *elem2);
