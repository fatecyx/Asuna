...
#define BASS_INVALID_POSITION -1
...
EXTC_IMPORT BOOL BASSDEF(BASS_SetConfig)(DWORD option, DWORD value);
...
EXTC_IMPORT BOOL BASSDEF(BASS_Init)(int device, DWORD freq, DWORD flags, HWND win, const GUID *dsguid);
#else
...
EXTC_IMPORT BOOL BASSDEF(BASS_Free)();
#if defined(_WIN32) && !defined(_WIN32_WCE)
...
EXTC_IMPORT float BASSDEF(BASS_GetCPU)();
BOOL BASSDEF(BASS_Start)();
BOOL BASSDEF(BASS_Stop)();
BOOL BASSDEF(BASS_Pause)();
EXTC_IMPORT BOOL BASSDEF(BASS_SetVolume)(float volume);
float BASSDEF(BASS_GetVolume)();

EXTC_IMPORT HPLUGIN BASSDEF(BASS_PluginLoad)(const char *file, DWORD flags);
EXTC_IMPORT BOOL BASSDEF(BASS_PluginFree)(HPLUGIN handle);
...
EXTC_IMPORT HSTREAM BASSDEF(BASS_StreamCreate)(DWORD freq, DWORD chans, DWORD flags, STREAMPROC *proc, void *user);
EXTC_IMPORT HSTREAM BASSDEF(BASS_StreamCreateFile)(BOOL mem, const void *file, QWORD offset, QWORD length, DWORD flags);
HSTREAM BASSDEF(BASS_StreamCreateURL)(const char *url, DWORD offset, DWORD flags, DOWNLOADPROC *proc, void *user);
EXTC_IMPORT HSTREAM BASSDEF(BASS_StreamCreateFileUser)(DWORD system, DWORD flags, const BASS_FILEPROCS *proc, void *user);
EXTC_IMPORT BOOL BASSDEF(BASS_StreamFree)(HSTREAM handle);
...
EXTC_IMPORT double BASSDEF(BASS_ChannelBytes2Seconds)(DWORD handle, QWORD pos);
EXTC_IMPORT QWORD BASSDEF(BASS_ChannelSeconds2Bytes)(DWORD handle, double pos);
EXTC_IMPORT DWORD BASSDEF(BASS_ChannelGetDevice)(DWORD handle);
EXTC_IMPORT BOOL BASSDEF(BASS_ChannelSetDevice)(DWORD handle, DWORD device);
EXTC_IMPORT DWORD BASSDEF(BASS_ChannelIsActive)(DWORD handle);
EXTC_IMPORT BOOL BASSDEF(BASS_ChannelGetInfo)(DWORD handle, BASS_CHANNELINFO *info);
EXTC_IMPORT const char *BASSDEF(BASS_ChannelGetTags)(DWORD handle, DWORD tags);
EXTC_IMPORT DWORD BASSDEF(BASS_ChannelFlags)(DWORD handle, DWORD flags, DWORD mask);
EXTC_IMPORT BOOL BASSDEF(BASS_ChannelUpdate)(DWORD handle, DWORD length);
EXTC_IMPORT BOOL BASSDEF(BASS_ChannelLock)(DWORD handle, BOOL lock);
EXTC_IMPORT BOOL BASSDEF(BASS_ChannelPlay)(DWORD handle, BOOL restart);
EXTC_IMPORT BOOL BASSDEF(BASS_ChannelStop)(DWORD handle);
EXTC_IMPORT BOOL BASSDEF(BASS_ChannelPause)(DWORD handle);
EXTC_IMPORT BOOL BASSDEF(BASS_ChannelSetAttribute)(DWORD handle, DWORD attrib, float value);
EXTC_IMPORT BOOL BASSDEF(BASS_ChannelGetAttribute)(DWORD handle, DWORD attrib, float *value);
EXTC_IMPORT BOOL BASSDEF(BASS_ChannelSlideAttribute)(DWORD handle, DWORD attrib, float value, DWORD time);
EXTC_IMPORT BOOL BASSDEF(BASS_ChannelIsSliding)(DWORD handle, DWORD attrib);
EXTC_IMPORT BOOL BASSDEF(BASS_ChannelSet3DAttributes)(DWORD handle, int mode, float min, float max, int iangle, int oangle, float outvol);
EXTC_IMPORT BOOL BASSDEF(BASS_ChannelGet3DAttributes)(DWORD handle, DWORD *mode, float *min, float *max, DWORD *iangle, DWORD *oangle, float *outvol);
EXTC_IMPORT BOOL BASSDEF(BASS_ChannelSet3DPosition)(DWORD handle, const BASS_3DVECTOR *pos, const BASS_3DVECTOR *orient, const BASS_3DVECTOR *vel);
EXTC_IMPORT BOOL BASSDEF(BASS_ChannelGet3DPosition)(DWORD handle, BASS_3DVECTOR *pos, BASS_3DVECTOR *orient, BASS_3DVECTOR *vel);
EXTC_IMPORT QWORD BASSDEF(BASS_ChannelGetLength)(DWORD handle, DWORD mode);
EXTC_IMPORT BOOL BASSDEF(BASS_ChannelSetPosition)(DWORD handle, QWORD pos, DWORD mode);
EXTC_IMPORT QWORD BASSDEF(BASS_ChannelGetPosition)(DWORD handle, DWORD mode);
EXTC_IMPORT DWORD BASSDEF(BASS_ChannelGetLevel)(DWORD handle);
EXTC_IMPORT DWORD BASSDEF(BASS_ChannelGetData)(DWORD handle, void *buffer, DWORD length);
EXTC_IMPORT HSYNC BASSDEF(BASS_ChannelSetSync)(DWORD handle, DWORD type, QWORD param, SYNCPROC *proc, void *user);
EXTC_IMPORT BOOL BASSDEF(BASS_ChannelRemoveSync)(DWORD handle, HSYNC sync);
EXTC_IMPORT HDSP BASSDEF(BASS_ChannelSetDSP)(DWORD handle, DSPPROC *proc, void *user, int priority);
EXTC_IMPORT BOOL BASSDEF(BASS_ChannelRemoveDSP)(DWORD handle, HDSP dsp);
EXTC_IMPORT BOOL BASSDEF(BASS_ChannelSetLink)(DWORD handle, DWORD chan);
EXTC_IMPORT BOOL BASSDEF(BASS_ChannelRemoveLink)(DWORD handle, DWORD chan);
EXTC_IMPORT HFX  BASSDEF(BASS_ChannelSetFX)(DWORD handle, DWORD type, int priority);
EXTC_IMPORT BOOL BASSDEF(BASS_ChannelRemoveFX)(DWORD handle, HFX fx);

EXTC_IMPORT BOOL BASSDEF(BASS_FXSetParameters)(HFX handle, const void *params);
EXTC_IMPORT BOOL BASSDEF(BASS_FXGetParameters)(HFX handle, void *params);
EXTC_IMPORT BOOL BASSDEF(BASS_FXReset)(HFX handle);
