...
.data
  ...
  UrlArray		BYTE	'http://www.radioparadise.com/musiclinks/rp_128-9.m3u', 0
			...
			BYTE	'http://www.sky.fm/mp3/classical.pls', 0
			BYTE	'http://www.sky.fm/mp3/classical_low.pls', 0
			BYTE	'http://www.sky.fm/mp3/the80s.pls', 0
			BYTE	'http://www.sky.fm/mp3/the80s_low.pls', 0
			BYTE	'http://somafm.com/tags.pls', 0
			BYTE	'http://somafm.com/tags32.pls', 0
