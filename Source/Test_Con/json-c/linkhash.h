 ...
 */
extern struct lh_table* lh_table_new(int size, const wchar_t *name,
				     lh_entry_free_fn *free_fn,
				     lh_hash_fn *hash_fn,
				     lh_equal_fn *equal_fn);
 ...
 * @return a pointer onto the linkhash table.
 */
extern struct lh_table* lh_kchar_table_new(int size, const wchar_t *name,
					   lh_entry_free_fn *free_fn);
 ...
 * @return a pointer onto the linkhash table.
 */
extern struct lh_table* lh_kptr_table_new(int size, const wchar_t *name,
					  lh_entry_free_fn *free_fn);
