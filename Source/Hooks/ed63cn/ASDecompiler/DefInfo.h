...
{
    DECL_HANDLER(CED6AsDecompiler::*Handler);
...
#define SET_HANDLER(handler, ins, ...) \
            { &CED6AsDecompiler::handler, ins, __VA_ARGS__ }
...
PARAM_DESC(Desc0B, COMMON_PARAM_TARGET(0), COMMON_PARAM_TARGET(1));
...
ED6_AS_INSTRUCTION_MAP g_InstructionMap[] =
{
    ...
    SET_HANDLER(Handle0B, AS_TURN,              "Turn",             SET_DESC(Desc0B)),
    SET_HANDLER(Handle0C, AS_0C,                NULL),
    ...
    SET_HANDLER(Handle30, AS_30,                NULL),
    ...
    SET_HANDLER(Handle37, AS_ROTATION_ANGLE,    "RotationAngle"),
    SET_HANDLER(Handle38, AS_ROTATION_ANGLE_V,  "RotationAngleVert"),
    ...
    SET_HANDLER(Handle4B, AS_RANDOM,            "Random"),
    ...
    SET_HANDLER(Handle62, AS_62,                NULL),
    SET_HANDLER(Handle63, AS_63,                NULL),
    ...
    SET_HANDLER(Handle68, AS_68,                "Nop"),              // nop
    SET_HANDLER(Handle69, AS_RELEASE_TEXTURE,   "ReleaseTexture"),
    ...
    SET_HANDLER(Handle74, AS_74,                NULL),
    SET_HANDLER(Handle75, AS_75,                NULL),
    SET_HANDLER(Handle76, AS_76,                NULL),
    ...
    SET_HANDLER(Handle81, AS_81,                NULL),
    ...
    SET_HANDLER(Handle85, AS_85,                NULL,               SET_DESC(Desc85)),
    SET_HANDLER(Handle86, AS_86,                NULL),
    ...
    SET_HANDLER(Handle90, AS_90,                NULL),
    ...
    SET_HANDLER(Handle98, AS_98,                NULL),
    ...
    SET_HANDLER(Handle9D, AS_9D,                NULL),
    ...
    SET_HANDLER(HandleA2, AS_A2,                NULL),
    SET_HANDLER(HandleA3, AS_A3,                NULL),
    SET_HANDLER(HandleA4, AS_A4,                NULL),
    SET_HANDLER(HandleA5, AS_A5,                NULL),
    ...
    SET_HANDLER(HandleAB, AS_AB,                NULL),
    ...
    SET_HANDLER(Handle8B, AS_CUSTOM_8B,         NULL),
};
