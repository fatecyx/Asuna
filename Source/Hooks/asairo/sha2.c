...
ASM Void WINAPI sha256(const unsigned char *message, unsigned int len, unsigned char *digest)
{
    static DWORD table[] = 
    {
    ...
    __asm
    {
        ...
        push    dword ptr [ebp+010h]
            push    esi
            call    lbex_sc_71608078            ;<= Jump/Call 地址无法决定
            add     esi, 040h
            dec     edi
            jnz     lbex_sc_7160800D
...
lbex_sc_71608078:                           ;<= Procedure Start
