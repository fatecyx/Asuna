...
public:
    ...
    DECL_HANDLER(HandleB2);
    DECL_HANDLER(HandleB3);
    DECL_HANDLER(HandleB4);
    DECL_HANDLER(HandleB5);
    DECL_HANDLER(HandleB6);
    DECL_HANDLER(HandleB7);
    DECL_HANDLER(HandleB8);
};
...
#define NAME_INTRINSIC_CRAFT10          "SysCraft_EnterBattle"
...
#define NAME_INTRINSIC_CRAFT14          "SysCraft_Reserve1"
#define NAME_INTRINSIC_CRAFT15          "SysCraft_Reserve2"
#define NAME_INTRINSIC_CRAFT16          "SysCraft_Counter"

#define INTRINSIC_CRAFT_COUNT           (16L)
