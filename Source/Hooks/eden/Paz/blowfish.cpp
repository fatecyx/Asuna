...
CBlowFish::CBlowFish ()
{
    ...
    PArray = (LPDWORD)HeapAlloc(m_hHeap, 0, 18 * sizeof(DWORD));
    SBoxes = (DWORD (*)[256])HeapAlloc(m_hHeap, 0, 4 * 256 * sizeof(DWORD));
}

CBlowFish::~CBlowFish ()
{
    HeapFree(m_hHeap, 0, PArray);
    HeapFree(m_hHeap, 0, SBoxes);
}
