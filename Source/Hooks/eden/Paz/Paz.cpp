...
Int32 STDCALL GenEntryCallBack(LPVoid lpBuffer, PWIN32_FIND_DATAW pwfd)
{
    TMyPAZEntry *pEntry = (TMyPAZEntry *)lpBuffer;

    return WideCharToMultiByte(CP_SHIFTJIS, 0, pwfd->cFileName, -1, pEntry->szName, sizeof(pEntry->szName), 0, 0);
}
...
int __unused(TMyPAZEntry **ppMyPAZEntry)
//DWORD WINAPI GenerateEntry(TMyPAZEntry **ppMyPAZEntry)
{
    HANDLE hFind, hHeap;
